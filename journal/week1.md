...
If you lose your statefile, you'll have to tear down all your cloud infrastructure manually.
...
It's recommend to place modules in a `modules` directory when locally developing modules, but you can name it whatever you like.
